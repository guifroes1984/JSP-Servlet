...
<%@ taglib uri = "http://java.sun.com/jsp/jstl/core" prefix = "c"%> <!-- Declaração na tela do JSP -->
											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														<h4 class="sub-title">Relatório de Gráfico</h4>
														
														 <form class="form-material" 
															 action="<%= request.getContextPath() %>/ServletUsuarioController" 
															 method="get" id="formUser">
														 
														 <input type="hidden" id="acaoRelatorioImprimirTipo" name="acao" value="imprimirRelatorioUser"> <!-- Passa os parametros do relatório escondido -->
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script> <!-- Instalação do JavaScript para gerar gráficos -->
...
/*Só está criando o gráfico*/
var myChart = new Chart(document.getElementById('myChart'));


/*---------------------------------------------------------------------------------------------------------------------------------------------*/

/*Função que mostra na tela os grafico*/
