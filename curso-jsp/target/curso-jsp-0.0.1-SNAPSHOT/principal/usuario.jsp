...
<%@ taglib prefix = "c" uri = "http://java.sun.com/jsp/jstl/core" %> <!-- Declaração na tela do JSP -->
                                                        ...
                                                        <h4 class="sub-title">Cadastro de Usuário</h4>
                                                          ...
                                                          <input type="hidden" name="acao" id="acao" value="">
															...
															<select class="form-control"
																...
																<option disabled="disabled">[Seleciona o Perfil]</option>
...
<span id="totalResultados"></span>
 ...
 /*Função que deixa no formato de dinheiro, e não aceita letras tbm, só numeros*/
 ...
 /*Função que traduz o calendário, pega o campo e cria um calendario em cima dele*/
 $( function() {
 ...
 /*Função que faz que o campo "Numero" da tela só aceite números não aceita letras, passando o id=numero */
 ...
 /*---------------------------------------------------------------------------------------------------------------------------------------------*/
  ...
  /*Função que faz que o campo "Cep" da tela só aceite números não aceita letras, passando o id=cep */
...
$("#cep").keypress(function (event) {
 ...
 /*Função que faz o auto complite do cep, somente digitando o cep*/
 ...
 function visualizarImg(fotoembase64, fileFoto) {
	 ...
	 var preview = document.getElementById(fotoembase64);/*Campo IMG html que vamos pegar*/
 ...
 function verEditar(id) {
	 ...
	 var urlAction = document.getElementById('formUser').action;/*É a url para onde está indo. See tiver duvida é só fazer: 'alert(urlAction);' e ir no projeto mostrar para onde está indo */
	 	 
	 window.location.href = urlAction + '?acao=buscarEditar&id=' + id;/*Faz o redirecionamento só que em JavaScript*/
 ...
 /*Função JavaScript que abre o uma telinha, buscando os usuários cadastrados no banco de dados, pelo: "id, nome," e tem um botão verEditar*/
 ...
 /*Função JavaScript que abre uma janela se realmente quer excluir contato, usando ajax*/
 ...
 /*Função JavaScript que abre uma janela se realmente quer excluir contato*/
 ...
 /*Função JavaScript que limpa o formulário*/
 function limparForm() {
